...
<body>
	...
	<div class="user-info-list-pannel">
		...
		<div class="top-header-pannel">
			...
			<div class="function-btn-pannel">
				...
				<button class="personalHistoryListAllBtn">
					리스트로
				</button>
			</div>
		</div>
		...
		<table class="user-info-table1">
			...
			<tbody>
				<tr>
					...
					<td style="display: blcok;" rowspan="3">
						<div id="imgDiv" >
		...
		<div class="body-info-pannel">
		<table class="body-info flexibleTable" tb="body">
			<thead>
				<tr>
					<td colspan="2">혈액형</td>
					<td colspan="2">몸무게</td>
					<td colspan="2">신장</td>
					<td colspan="2">시력 (좌, 우)</td>
				</tr>
			</thead>
			<tbody>
				
			<tr>
					<td><input type="text" data="bodyBloodType" class="bodyBloodType" ></td>
					<td>형</td>            
					<td><input type="number" data="bodyWeight" class="bodyWeight" ></td>
					<td>kg</td>            
					<td><input type="number" data="bodyHeight" class="bodyHeight" ></td>
					<td>cm</td>            
					<td><input type="number" data="bodyVisionLeft" class="bodyVisionLeft" ></td>
					<td><input type="number" data="bodyVisionRight" class="bodyVisionRight" ></td>
				</tr></tbody>
		</table>
		</div>
				...
				<table class="edu-table flexibleTable" tb="edu">
					...
					<tbody>
						<tr>
							...
							<td><input type="text" data="eduDay" placeholder="" class="eduDay dateInput"></td>
	...
	<div class="pop-user-register-pannel" id="drag-ele1">
		...
		<div class="pop-user-search-pannel">
			...
			<input type="hidden" id="userInfoPageSize" value="5"><!--기본값 10, 테스트로 바꿔봄,, 이상없을시 10으로 수정할것-->
			<input type="hidden" id="userInfoPageNo" value="1">
			
			<select id="userListSearchPeriod">
				<option value="userName">검색조건</option>
			...
			<select id="userInfoDataSize">
				<option value="3">3개씩</option><!--테스트용임, 이상없을시 삭제할것-->
	...
	<script>
      ...
      //var id = <%=request.getAttribute("idx")%>;
      var id = "${userIdx}"
      console.log("id:"+id);
      if(id!=null){
         getRegisterData(id); //이게 홈.jsp 화면에 뿌려주는
      }
   </script>
